...
const NEIGHBORHOODS = {
  ...
  "רמת גן": [
    "הבורסה", "הביל\"ויים", "הגפן ונחלת גנים", "הלל",
    "הראשונים", "ותיקים", "חרוזים", "יד לבנים, נגבה ותל יהודה",
    "לב העיר", "נווה יהושע", "ציר זבוטינסקי", "קרית בורוכוב",
    "רמת אפעל", "רמת חן", "רמת עמידר", "רמת שקמה",
    "שיכון מזרחי", "תל בנימין", "תל גנים",
  ],
  "אשדוד": [
