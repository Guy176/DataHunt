...
const NEIGHBORHOODS = {
  // שכונות רשמיות לפי עיריית תל אביב-יפו
  "תל אביב": [
    "כרם התימנים", "נווה צדק", "מונטיפיורי", "לב העיר",
    "הצפון הישן", "הצפון החדש", "פלורנטין", "שפירא",
    "שכונת התקווה", "יד אליהו", "קרית שלום", "נחלת יצחק",
    "בבלי", "פארק צמרת", "הדר יוסף", "נווה שרת", "גבעת עמל",
    "רמת אביב", "אפקה", "נווה אביבים", "רמת החייל", "צהלה",
    "יפו", "עג'מי", "גבעת עלייה", "אבו כביר",
  ],
  // שכונות ירושלים בגבולות העירייה
  "ירושלים": [
    "רחביה", "טלביה", "המושבה הגרמנית", "קטמון הישנה", "קטמון החדשה",
    "גבעת מרדכי", "בקעה", "תלפיות", "ארנונה", "גילה", "הר חומה",
    "קרית מנחם", "עיר גנים", "קרית יובל", "בית הכרם", "קרית משה",
    "גבעת שאול", "הר נוף", "רמות", "פסגת זאב", "הגבעה הצרפתית",
    "נחלאות", "מאה שערים", "עין כרם", "מלחה", "גבעת המטוס",
    "רמת שרת", "רמת דניה",
  ],
  // שכונות חיפה בגבולות העירייה
  "חיפה": [
    "כרמל מרכזי", "כרמליה", "דניה", "אחוזה", "רמת הנשיא",
    "רמת ויצמן", "רמות ספיר", "נווה שאנן", "הדר הכרמל",
    "עיר תחתית", "המושבה הגרמנית", "בת גלים", "קרית חיים",
    "קרית שפרינצק", "קרית אליעזר", "חליסה", "ואדי ניסנאס",
  ],
  "ראשון לציון": [
  ...
  "פתח תקווה": [
    ...
    "סגולה", "שיכון ותיקים", "נאות דשא", "אם המושבות", "גני סביון",
  ],
  "נתניה": [
    "מרכז העיר", "עיר ימים", "קרית נורדאו", "קרית השרון",
    "רמת פולג", "אגמים", "נווע עמיקם", "גני הדר", "שכונת פולג",
  ],
  "באר שבע": [
  ...
  "בני ברק": [
    "מרכז העיר", "פרדס כץ", "קרית הגר\"א", "רחוב רבי עקיבא",
    "זיכרון מאיר", "שומרי אמונים",
  ],
  "חולון": [
    "מרכז העיר", "קרית שרת", "נאות דשא", "שיכון ז",
    "גבעת הרצל", "רובע ד",
  ],
  "רמת גן": [
  ...
  "אשדוד": [
    ...
    "רובע ו", "רובע ז", "רובע ח", "רובע ט", "לב ים", "צפון העיר",
  ],
  "נתניה": [
    "מרכז העיר", "עיר ימים", "קרית נורדאו", "קרית השרון",
    "רמת פולג", "אגמים", "גני הדר",
  ],
  "בת ים": [
    "מרכז העיר", "רובע ז", "נווע עופר", "גבעת הים",
  ],
  "כפר סבא": [
    "מרכז העיר", "רמת כפר סבא", "גנים", "עין סמריה",
  ],
  "הרצליה": [
    "הרצליה פיתוח", "הרצליה ב", "נווע עמל", "גליל ים", "שכונת אגוז",
  ],
  "אשקלון": [
    "ברנע", "מיגדל", "ממשית", "צאלים", "אפרידר",
    "גיורא", "בנה ביתך", "שמשון",
  ],
  "רחובות": [
    "מרכז העיר", "קרית משה", "נאות גנים", "גנות",
    "שכונת הפועלים", "רמת שמשון",
  ],
  "מודיעין": [
    "מורשה", "אמירים", "ספיר", "גנות", "שקמה",
    "הגנים", "המעיין", "יובלים",
  ],
};
